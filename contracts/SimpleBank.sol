...
contract SimpleBank {
    ...
    function enroll() public returns (bool) {
        require(!enrolled[msg.sender],"User Already exists");
    ...
    function deposit() public payable returns (uint256) {
        /* Add the amount to the user's balance, call the event associated with a deposit,
          ...
          require(enrolled[msg.sender],"account does not exists");
    ...
    function withdraw(uint256 withdrawAmount) public payable returns (uint256) {
        /* If the sender's balance is at least the amount they want to withdraw,
           ...
           require(( balances[msg.sender]>= withdrawAmount ) ,"No sufficient Balance");
